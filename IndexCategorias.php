...
<body>
    ...
    <div class="container">
        <h1 class="page-header text-center">Categorias Registradas</h1>
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2" id="MainDiv">
                ...
                <a href="#addnew" class="btn btn-primary" data-toggle="modal">
                    <span class="glyphicon glyphicon-plus"></span> Registrar Categoria</a>
                ...
                <table id="ProductTable" class="table table-bordered table-striped" style="margin-top:20px;">
                    ...
                    <tbody>
                        <!-- Aqui se muestra el listado de categorias -->
                    </tbody>
                </table>
    ...
    <?php include('ventanasModals/categorias/modal_Registrar.php'); ?>
    <script src="assets/js/jquery.min.js"></script>
    <script src="assets/js/bootstrap.min.js"></script>
    <script src="assets/js/AjaxCategoria.js"></script>
